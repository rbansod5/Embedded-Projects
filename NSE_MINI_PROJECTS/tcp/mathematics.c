...
int *insertionSortArray(int *array)
{
	// logic
}
...
void starPattern(int range)
{
	// logic
}

void triangularPattern(int height, int width)
{
	// logic
}

void squarePattern(int height)
{
	// logic
}

void dimondPattren(int range)
{
	// logic
}

int **addTwoMatrix(int **mat1, int **mat2)
{
	// logic
}

int **subTwoMatrix(int **mat1, int **mat2)
{
	// logic
}

int **inverseMatrix(int **mat)
{
	// logic
}
...
char *floatToAscii(float number)
{
	// logic
}
