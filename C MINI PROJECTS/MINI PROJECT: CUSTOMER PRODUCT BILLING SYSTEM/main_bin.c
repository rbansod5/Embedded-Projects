...
#include "macros.h"      //for extra tools
#include "structure.h"   //for store strcture database
#include "declaration.h" //for declaration of functions
#include "colors.h"      //for string colors
...
int main()
{
    ...
    while (1)
    {
        ...
        case 9: // buy produts
            ...
            // printf(RED "Please enter Id to Display Bill(0 to go Main Manu)\n" RESET);
