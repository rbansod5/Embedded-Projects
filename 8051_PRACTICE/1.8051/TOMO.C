...
Lower niblle of TMOD we need to select based on requirement, because lower nibble representing 
Timer0
Mode0 - 13 bit timer - 2^13- 8192 using M1 & M0 bits
...
When it is High then we got DTD
