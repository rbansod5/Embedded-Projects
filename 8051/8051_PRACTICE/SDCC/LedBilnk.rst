      ...
      000003 02 00 62         [24]  347 	ljmp	_main
                                    ...
                                    355 ;------------------------------------------------------------
                                    356 ;	LedBilnk.c:4: void main(void)
                                    357 ;	-----------------------------------------
                                    358 ;	 function main
                                    359 ;	-----------------------------------------
      000062                        360 _main:
                           ...
                           000001   367 	ar1 = 0x01
                           000000   368 	ar0 = 0x00
                                    369 ;	LedBilnk.c:6: while(1)
      000062                        370 00102$:
                                    371 ;	LedBilnk.c:8: P1 = 0xFF; // Turn ON all LED's connected to Port1
      000062 75 90 FF         [24]  372 	mov	_P1,#0xff
                                    373 ;	LedBilnk.c:9: delay();
      000065 12 00 70         [24]  374 	lcall	_delay
                                    375 ;	LedBilnk.c:10: P1 = 0x00; // Turn OFF all LED's connected to Port1
      000068 75 90 00         [24]  376 	mov	_P1,#0x00
                                    377 ;	LedBilnk.c:11: delay();
